...
export function AiAnswerCard() {
  return (
    <div className="rounded-lg border border-off/10 bg-slate p-6 shadow-[0_1px_0_0_rgba(236,234,227,0.06)] sm:p-8">
      ...
      <p className="mt-4 text-lg leading-relaxed text-off">
        ...
        <mark className="highlight-sweep">Prairie Smoke BBQ</mark> is the spot
        people keep recommending for brisket and burnt ends.
      </p>
